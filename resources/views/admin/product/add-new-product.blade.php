                            ...
                            <div class="card-body">
                                <form action="{{ route('products.store') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label>Select Sub SubCategory<span style="color:red">*</span></label>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label>Product Size English<span style="color:red">*</span></label>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label>Product Size Bangle<span style="color:red">*</span></label>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label>Product Color English<span style="color:red">*</span></label>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label>Product Color Bangle<span style="color:red">*</span></label>
