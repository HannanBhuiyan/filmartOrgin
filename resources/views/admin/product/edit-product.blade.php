                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" rows="3" name="product_desc_en" placeholder="Example...">{{ $products->product_desc_en }}</textarea>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" rows="3"  name="product_desc_bn" placeholder="উদাহরণ ..." >{{ $products->product_desc_bn }}</textarea>
...
@section('scripts')
    <script type="text/javascript">
        ...
        $('select[name="category_id"]').on('change', function(event){
            ...
            axios.get('updateChangeSubcategory/'+ category_id)
        ...
        $('select[name="subcategory_id"]').on('change', function(event){
            ...
            axios.get('updateChangeSubSubcategory/'+ subcategory_id)
                .then(function(response){
                    if(response.status === 200){
