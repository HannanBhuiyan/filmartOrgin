...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            "product_size_en.required" => "Field is required",
            "product_size_bn.required" => "Field is required",
            "product_color_en.required" => "Field is required",
            "product_color_bn.required" => "Field is required",
    ...
    public function editFunc($id){
        ...
        return view('admin.product.edit-product', compact('products', 'categorys', 'multiimages'));
    }
